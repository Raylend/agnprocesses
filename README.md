...
## Recommendations
If you still do not have your favorite code editor I recommend to install [Atom](https://atom.io/). It can be installed using software center in Ubuntu distribution.
