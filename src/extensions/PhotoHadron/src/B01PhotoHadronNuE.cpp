...
{
public:
    B01PhotoHadronNuE(std::string data_dir_path);
    ~B01PhotoHadronNuE();
    int Test();
    int Init();
    int ReadTable();
...
B01PhotoHadronNuE::B01PhotoHadronNuE(std::string data_dir_path)
{
...
int B01PhotoHadronNuE::Test()
{
    ...
    fp= fopen((data_dir + "PhotoHadron-NuE-30").c_str(), "w");
    if (fp == NULL)
    {
