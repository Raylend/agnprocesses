...
folder = "test78_NEW_MC_primary_gamma_field_30000_eps_thr=1e+05eV_no_losses_below_threshold_1e+09---1e+15eV_photon_max=None_further_than_90_per_cent_RBLR"
...
l = 0.1 * r_blr  # maximum possible distance travelled by hadronic gamma rays
print("l = {:.3e}".format(l))
