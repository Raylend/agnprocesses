...
def separate_continuum_and_spikes(y_input, x_input,
    ...
    x_starters = x[:-1][difference == True][0::2]
    x_enders = x[:-1][difference == True][1::2]
    return (x_starters, x_enders)
...
x_starters, x_enders = separate_continuum_and_spikes(
    field_numpy[:, 1],
    field_numpy[:, 0],
    std_window_width=std_window_width,
    filt_value=4.0
...
print("Number of detected high lines = ", len(x_starters))
